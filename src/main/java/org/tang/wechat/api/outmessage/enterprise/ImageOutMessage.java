...
public class ImageOutMessage extends OutEnterpriseMessage {
	...
	public String toXmlString() {
		...
		Element imageElement = root.addElement(OetpmUtils.PKG_IMAGE_CONTENT);
		imageElement.addElement(OetpmUtils.PKG_IMAGE_MEDIAID).addCDATA(mediaId);
		return root.asXML();
	}
