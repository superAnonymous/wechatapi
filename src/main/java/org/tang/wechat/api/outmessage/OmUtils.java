...
public class OmUtils {
    private final static Logger logger = LoggerFactory.getLogger(OmUtils.class);
	...
	public static final String PKG_FILE_MEDIAID = "media_id";
	 ...
	 * @return OutMessage
	 */
	public static OutMessage createOutMessage(Message message, String content, String msgType) {
	 ...
	 */
	public static List<OutMessage> outSingleMessage(Message message, String content, String msgType) {
		if (msgType.equalsIgnoreCase(TextOutMessage.MSGTYPE)) {
			...
			return new ArrayList<OutMessage>();
		}
			
	}

	public static List<OutMessage> outSingleMessage(OutMessage out) {
		List<OutMessage> outs = new ArrayList<OutMessage>();
		outs.add(out);
		return outs;
	}

	public static List<OutMessage> outSingleTextMessage(Message message, String content) {
		OutMessage out = createTextOutMessage(message, content);
		return outSingleMessage(out);
	}

	public static List<OutMessage> outSingleNewsMessage(Message message, String content) {
		OutMessage out = createNewsOutMessage(message, content);
		return outSingleMessage(out);
	}

	public static List<OutMessage> outSingleMusicMessage(Message message, String content) {
		OutMessage out = createMusicOutMessage(message, content);
		return outSingleMessage(out);
	}

	public static List<OutMessage> outSingleImageMessage(Message message, String content) {
		OutMessage out = createImageOutMessage(message, content);
		return outSingleMessage(out);
	}

	public static List<OutMessage> outSingleVoiceMessage(Message message, String content) {
		OutMessage out = createVoiceOutMessage(message, content);
		return outSingleMessage(out);
	}

	public static List<OutMessage> outSingleVideoMessage(Message message, String content) {
		OutMessage out = createVideoOutMessage(message, content);
		return outSingleMessage(out);
	}
	
	public static List<OutMessage> outSingleFileMessage(Message message, String content) {
		OutMessage out = createFileOutMessage(message, content);
		return outSingleMessage(out);
	}
