...
//        String sReqData = "<xml><AppId><![CDATA[wxb0f5a4f120488665]]></AppId><Encrypt><![CDATA[]]></Encrypt></xml>";
        ...
        try {
            String sEncodingAESKeyLocal = "nmOetBDpVmr4ZXu3VQS3XC9FxUuleeklSlgSdixsyAE";

            WXBizMsgCrypt wxcptLocal = new WXBizMsgCrypt(sToken, sEncodingAESKeyLocal, sCorpID);
            String sMsg = wxcptLocal.decryptMsg(sReqMsgSig, sReqTimeStamp, sReqNonce, sReqData);
            if (sMsg != null) {
